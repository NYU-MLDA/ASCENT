...
class PPO(OnPolicyAlgorithm):
    ...
    def __init__(
        ...
        ent_coef: float = 0.3,
        vf_coef: float = 0.5, #vf_coef: float = 0.35,
    ...
    def train(self) -> None:
        ...
        for epoch in range(self.n_epochs):
            ...
            for rollout_data in self.rollout_buffer.get(self.batch_size):
                ...
                values, log_prob, entropy = self.policy.evaluate_actions(rollout_data.observations[0], actions)
